...
public class LWWheelView<T> extends View
{
            ...
            int defStyleAttr)
    {
        ...
        initPaint();
        mLinearGradient = new LinearGradient(mTextColor,
    ...
    private void initAttrs(Context context, @Nullable AttributeSet attrs)
    {
        ...
        TypedArray a = context.obtainStyledAttributes(attrs,
                R.styleable.LWWheelView);
        mTextSize = a.getDimensionPixelSize(
                R.styleable.LWWheelView_itemTextSize,
                getResources()
                        .getDimensionPixelSize(R.dimen.WheelItemTextSize));
        mTextColor = a.getColor(R.styleable.LWWheelView_itemTextColor,
                Color.BLACK);
        mIsTextGradual = a.getBoolean(R.styleable.LWWheelView_textGradual,
                true);
        mIsCyclic = a.getBoolean(R.styleable.LWWheelView_wheelCyclic, false);
        mHalfVisibleItemCount = a
                .getInteger(R.styleable.LWWheelView_halfVisibleItemCount, 2);
        mItemMaximumWidthText = a
                .getString(R.styleable.LWWheelView_itemMaximumWidthText);
        mSelectedItemTextColor = a.getColor(
                R.styleable.LWWheelView_selectedTextColor,
                Color.parseColor("#33aaff"));
        mSelectedItemTextSize = a.getDimensionPixelSize(
                R.styleable.LWWheelView_selectedTextSize,
                getResources().getDimensionPixelSize(
                        R.dimen.WheelSelectedItemTextSize));
        mCurrentPosition = a
                .getInteger(R.styleable.LWWheelView_currentItemPosition, 0);
        mItemWidthSpace = a.getDimensionPixelSize(
                R.styleable.LWWheelView_itemWidthSpace,
                getResources()
                        .getDimensionPixelOffset(R.dimen.WheelItemWidthSpace));
        mItemHeightSpace = a.getDimensionPixelSize(
                R.styleable.LWWheelView_itemHeightSpace,
                getResources()
                        .getDimensionPixelOffset(R.dimen.WheelItemHeightSpace));
        mIsZoomInSelectedItem = a
                .getBoolean(R.styleable.LWWheelView_zoomInSelectedItem, true);
        mIsShowCurtain = a.getBoolean(R.styleable.LWWheelView_wheelCurtain,
                true);
        mCurtainColor = a.getColor(R.styleable.LWWheelView_wheelCurtainColor,
                Color.parseColor("#303d3d3d"));
        mIsShowCurtainBorder = a
                .getBoolean(R.styleable.LWWheelView_wheelCurtainBorder, true);
        mCurtainBorderColor = a.getColor(
                R.styleable.LWWheelView_wheelCurtainBorderColor,
                Color.BLACK);
        mIndicatorText = a.getString(R.styleable.LWWheelView_indicatorText);
        mIndicatorTextColor = a.getColor(
                R.styleable.LWWheelView_indicatorTextColor,
                mSelectedItemTextColor);
        mIndicatorTextSize = a.getDimensionPixelSize(
                R.styleable.LWWheelView_indicatorTextSize,
                mTextSize);
        a.recycle();
    }
    ...
    protected void onSizeChanged(int w, int h, int oldw, int oldh)
    {
        ...
        mFirstItemDrawY = (int) ((mItemHeight
    ...
    protected void onDraw(Canvas canvas)
    {
        ...
        if (!TextUtils.isEmpty(mIndicatorText))
        {
            ...
            canvas.drawText(mIndicatorText,
                    mFirstItemDrawX + mTextMaxWidth / 2,
                    mCenterItemDrawnY,
                    mPaint);
        }
    }
    ...
    public void setCurrentPosition(int currentPosition, boolean smoothScroll)
    {
        ...
        if (smoothScroll)
        {
            mScroller.startScroll(0,
                    mScrollOffsetY,
                    0,
                    (mCurrentPosition - currentPosition) * mItemHeight);
            mScroller.setFinalY(
